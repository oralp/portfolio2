...
$Referer_check_domain = "https://oralp.github.io/portfolio2/";
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('電話番号','金額','Email');
